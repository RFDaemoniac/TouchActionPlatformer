...
/*
				if (dir.x == 0 && lineFrom.x > lineTo.x){
					var midY = Mathf.Abs((lineTo - lineFrom).y/2) + Mathf.Min(lineFrom.y, lineTo.y);
					var extraPoint1 = new Vector3( (lineFrom + new Vector3(50,0,0)).x, midY);
					var extraPoint2 = new Vector3( (lineTo + new Vector3(-50,0,0)).x, midY);
					Handles.DrawPolyLine(lineFrom, lineFrom + new Vector3(50,0,0), extraPoint1, extraPoint2, lineTo + new Vector3(-50,0,0), lineTo);
					Handles.DrawPolyLine(lineFrom+shadow, (lineFrom + new Vector3(50,0,0))+shadow, extraPoint1+shadow, extraPoint2+shadow, (lineTo + new Vector3(-50,0,0))+shadow, lineTo+shadow);
				}
*/
